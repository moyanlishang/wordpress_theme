...
<div class="wrap rm_wrap">
  ...
  <div style=" margin-bottom:20px; text-align:right;"><a href="http://www.bevisz.com/" target="_blank">主题预览</a> / <a href="https://github.com/moyanlishang/wordpress_theme" target="_blank">更多源码</a></div>
  <div class="clear"></div>
  <div class="rm_opts">
  <div class="rm_opts">
  <form method="post">
...
<div class="theme-info">
    ...
    <blockquote>
    	<p></p>
        <p></p>
		<p>Bevis_blog<a href="https://github.com/moyanlishang" target="_blank">Bevis</a>：http://bevisz.com  技术交流QQ:5013321</p>
		<p style="font-size: 19px;"><a href="http://www.bevisz.com/" target="_blank">Bevis'BLOG</a>莫言离殇<a href="http://www.bevisz.com" target="_blank">Github</a>https://github.com/moyanlishang/wordpress_theme</p>
    </blockquote>
  </div>
<form method="post">
<p class="submit">
